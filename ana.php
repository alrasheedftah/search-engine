...
$googleSearch = new Ana();
$res=$googleSearch->getResults('some phrase');
$res=$googleSearch->getOutput();
// $res2=$googleSearch->getRawResult();
// // $info = $googleSearch->getSearchInformation(); // get search information
// // $info = $googleSearch->getTotalNumberOfResults(); // get search information
// // die(var_dump($res2));
print_r($res) ;
// foreach($res as $val)
// echo $val->title."<br>".$val->displayLink."<br>".$val->snippet."<br>".$res2->queries->previousPage[0]->searchTerms;//json_encode($key);
